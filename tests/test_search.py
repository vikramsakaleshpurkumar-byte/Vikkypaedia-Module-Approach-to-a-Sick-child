...
with sync_playwright() as pw:
    ...
    print("\n== RESULTS ==")
    p.fill("#srchInput","atropine"); p.wait_for_timeout(400)
    ...
    print("\n== LOCKED UNITS ==")
    p.fill("#srchInput","anti-snake venom"); p.wait_for_timeout(450)
    ...
    print("\n== NAVIGATION ==")
    p.fill("#srchInput","capillary refill"); p.wait_for_timeout(450)
    ...
    p.fill("#srchInput","deterioration continuum"); p.wait_for_timeout(450)
